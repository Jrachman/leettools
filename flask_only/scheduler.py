...
def choose_strategy(choice, strategies, list_of_ord_strats):
    while True:
        try:
...
if __name__ == "__main__":
    ...
    strat_choice, n_days = choose_strategy(problems, best_fits, strategies, time_range)
